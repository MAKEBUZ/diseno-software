...
public class Workers {
    public static void main(String[] args) {
        ...
        Secretario secretario = new Secretario("Paul", "Johnson", 87653212, "Calle Pilares manzana 789", 7, "3659897426", 25000, supervisor, "Despacho 1", "1234-61");
        ...
        Secretario nuevoSecretario = new Secretario("Sofia", "Silva", 887947879, "Maridiaz 34 calle 10 78 manzana 89", 0, "3452017654", 25000, supervisor, "Despacho 1", "3654-90");
